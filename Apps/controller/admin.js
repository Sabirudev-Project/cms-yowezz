app.controller("superadmin/sidebar", function ($scope, $rootScope, $routeParams, httpRequest, sidebarmin, $window, $location, sessions) {
    ...
    $scope.showSidebar = function (name) {
        console.log(name);
        if (name == "/superadmin") {
            $scope.sidebarContentUrl = "Pages/admin/page/dashboard.html";
        } else if (name == "/superadmin/users") {
            $scope.sidebarContentUrl = "Pages/admin/page/users.html?v=2";
        } else if (name == "/superadmin/sponsor") {
            $scope.sidebarContentUrl = "Pages/admin/page/sponsor.html?v=4";
        } else if (name == "/superadmin/wof") {
            $scope.sidebarContentUrl = "Pages/admin/page/wof.html?v=1";
        } else if (name == "/superadmin/video") {
            $scope.sidebarContentUrl = "Pages/admin/page/video.html?v=3";
        } else if (name == "/superadmin/bazzar") {
            $scope.sidebarContentUrl = "Pages/admin/page/bazzar.html?v=3";
        }
    };
...
app.controller("superadmin/users", function ($scope, $rootScope, $routeParams, httpRequest, notification, $log) {
    $scope.form = {};
    $scope.edit = {};
    $scope.delete = {};
    $scope.getUser = function () {
        httpRequest.get('admin/users', {}, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.usersData = response.data.data.data;
                } else {
    ...
    $scope.formEdit = function (index) {
        $scope.edit = $scope.usersData[index];
        console.log($scope.edit);
        $('#editModal').modal("show");
    }
    $scope.editUser = function () {
        httpRequest.put('admin/users/' + $scope.edit.id, $scope.edit, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
    ...
    $scope.formDelete = function (index) {
        $scope.delete = $scope.usersData[index];
        $('#deleteModal').modal("show");

    }

    $scope.deleteUser = function () {
        httpRequest.delete('admin/users/' + $scope.delete.id, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
...
app.controller("superadmin/wof", function ($scope, $rootScope, $routeParams, httpRequest, notification, $log) {
    $scope.form = {};
    $scope.edit = {};
    $scope.delete = {};
    $scope.getUser = function () {
        httpRequest.get('admin/wof', {}, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.usersData = response.data.data.data;
    ...
    $scope.editUser = function () {
        httpRequest.put('admin/wof/' + $scope.edit.id, $scope.edit, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
    ...
    $scope.deleteUser = function () {
        httpRequest.delete('admin/wof/' + $scope.delete.id, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
...
app.controller("superadmin/sponsor", function ($scope, $rootScope, $routeParams, httpRequest, notification, $log) {
    $scope.form = {};
    $scope.edit = {};
    $scope.delete = {};
    $scope.getUser = function () {
        httpRequest.get('admin/sponsor', {}, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.usersData = response.data.data.data;
    ...
    $scope.addUser = function () {
        // console.log($scope.form);
        httpRequest.post('admin/sponsor', $scope.form, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug($scope.form);
                if (response.data.status == 'success') {
                    $scope.getUser();
    ...
    $scope.editUser = function () {
        httpRequest.put('admin/sponsor/' + $scope.edit.id, $scope.edit, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
    ...
    $scope.deleteUser = function () {
        httpRequest.delete('admin/sponsor/' + $scope.delete.id, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
...
app.controller("superadmin/bazzar", function ($scope, $rootScope, $routeParams, httpRequest, notification, $log, Upload) {
    ...
    $scope.delete = {};
    $scope.getUser = function () {
        httpRequest.get('admin/bazzar', {}, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.usersData = response.data.data.data;
    ...
    $scope.editUser = function () {
        httpRequest.put('admin/bazzar/' + $scope.edit.id, $scope.edit, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
    ...
    $scope.deleteUser = function () {
        httpRequest.delete('admin/bazzar/' + $scope.delete.id, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
...
app.controller("superadmin/video", function ($scope, $rootScope, $routeParams, httpRequest, notification, $log) {
    $scope.form = {};
    $scope.edit = {};
    $scope.delete = {};
    $scope.getUser = function () {
        httpRequest.get('admin/video', {}, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.usersData = response.data.data.data;
    ...
    $scope.editUser = function () {
        httpRequest.put('admin/video/' + $scope.edit.id, $scope.edit, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
    ...
    $scope.deleteUser = function () {
        httpRequest.delete('admin/video/' + $scope.delete.id, __env.token).then(function (response) {
            if (response.status == 200) {
                $log.debug(response);
                if (response.data.status == 'success') {
                    $scope.getUser();
...
app.service("sidebarmin", function () {
    //sidebar
    (() => {
        var e, t = {
                750: () => {
